...
// Publishing an event
    ...
    public void makeComment(String message)
    {
        ...
        FacebookType publishMessageResponse = fbClient.publish(post.getId()+"/comments", FacebookType.class, Parameter.with("message", message));
        out.println("Published message ID: " + publishMessageResponse.getId());
    ...
    public void makeCommentOnProfile(String message)
    {
